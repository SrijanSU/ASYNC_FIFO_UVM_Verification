...
//============================================================
// Initially run the commented scoreboard code snippet 
// to verify if wfull matches. If there is mismatch report
// and work on corrected DUT. If no mismatch then use the 
// DUT's wfull signal and check on rest of the test cases
//============================================================
...
//     // --------------------------------------------------------
//     // Analysis FIFOs and Expected FIFO Storage
//     // --------------------------------------------------------
...
//     // --------------------------------------------------------
//     // Run Phase: Start Write and Read Monitoring
//     // --------------------------------------------------------
...
//     // --------------------------------------------------------
//     // Report Phase: Display Final Summary
//     // --------------------------------------------------------
...
//     // --------------------------------------------------------
//     // Task: Handle Write Transactions
//     // --------------------------------------------------------
//     task writes();
//         forever begin
...
//             if (write_item.winc && !exp_full) begin
//                 if (exp_fifo.used() == exp_fifo.size()) begin
//                     `uvm_error("SCOREBOARD",
//                                $sformatf("WRITE is full in scoreboard but not in DUT (depth=%0d)",
//                                          exp_fifo.used()));
//                 end
//                 else begin
...
//                     `uvm_info("SCOREBOARD",
//                               $sformatf("WRITE: stored %0d (depth now=%0d)",
//                                         cloned.wdata, exp_fifo.used()),
//                               UVM_MEDIUM);
//                 end

//                 if (write_item.wfull !== exp_full) begin
//                     `uvm_error("SCOREBOARD",
//                                $sformatf("WFULL MISMATCH: DUT=%0b EXP=%0b depth=%0d",
...
//                 `uvm_info("SCOREBOARD",
//                           $sformatf("WRITE BLOCKED (old_wfull=1): no data written, depth=%0d",
//                                     exp_fifo.used()),
//                           UVM_LOW);
//             end
//         end
...
//                         `uvm_info("SCOREBOARD",
//                                   "READ blocked as expected (depth=0)",
//                                   UVM_LOW);
//                     end
//                 end
//                 else begin
